...
public class DiagramController
{
    ...
    public void createClass(String name)
    {
        ...
        {
            System.out.println("ERROR: Class name \"" + name + "\" is an invalid name");
            return;
        }
    ...
    public void createAttribute(String clasName, String attrName){
        ...
        if(tempClass != null)
        {
            ...
            {
                System.out.println("ERROR: Attribute name \"" + attrName + "\" is an invalid name");
                return;
            }
    ...
    //get a relationship for with <src> <dest>
