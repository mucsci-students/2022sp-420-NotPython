...
public class SaveLoadTest
{
    ...
    public void testThrowAnException() throws IOException{
        Load load = new Load();
        Map <String, Object> map = load.loadFile("0xwexdffDSFSDFSEECXCDfdfsd.json");
    }
    ...
    public void testLoadMethods()
    {
        ...
        dg.createMethod("dummy", "string", "name1", parms);
        ...
        assertTrue("Method not loaded", dg.getMethod("dummy", "name1") != null);
        assertTrue("Method has parameters that shouldn't exist", dg.getMethod("dummy", "name1").parameters.size() == 0);
